...
declare module "@nomicfoundation/hardhat-ethers/types" {
  ...
  getContractFactory(name: 'BuyMeACoffee', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.BuyMeACoffee__factory>
getContractFactory(name: 'Counter', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.Counter__factory>

  getContractAt(name: 'BuyMeACoffee', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.BuyMeACoffee>
getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>

  deployContract(name: 'BuyMeACoffee', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.BuyMeACoffee>
deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>

  deployContract(name: 'BuyMeACoffee', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.BuyMeACoffee>
