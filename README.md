...
| 日期范围 | 学习主题 | 学习内容概述 |
| :---: | :--- | :--- |
| **9.10 - 9.20** | **UniswapV2\_Chinese** | **UniswapV2** 核心合约代码逐行深度解析。 |
| **9.20 - 9.23** | **UniswapV3\_Chinese** | **UniswapV3** 核心合约代码逐行深度解析。 |
| **9.23 - 9.24** | **Uniswap\_Explain\_Examples** | **Uniswap** 平台实际操作记录与交易解析。 |
...
-----
-----
## 第二学期开始 11.10-2026.2.12
-----

| 日期范围 | 学习主题 | 学习内容概述 |
| :---: | :--- | :--- |
| **11.7 - 11.8** | **Kaia_book** |一个全新的笔记目录，记录我在Kaia学习的过程|  
| **11.7 - 11.8** | **Kaia_book/What is Kaia** |<br>**Kaia概述** : 详细介绍Kaia，解析它和EVM的区别|
| **11.9 - 11.10** | **Sidechain** |<br>**侧链概述** : 解读侧链的具体项目|    
| **11.10 - 11.12** | **RWA** |<br>**RWA概述** : 解读RWAS的具体项目，具体应用，和基本原理|  
| **11.11 - 11.13** | **Inscription** |<br>**铭文概述** : 简单了解铭文|  
| **11.14 - 11.21** | **Go Test** |<br>**Go 继续学习** : 强化Go的学习|  
| **11.22 - 11.29** | **Solana/rust_start** |<br>**rust 开发入门** : 从0开始学习rust|  
...
## 🌟 里程碑
  ...
  * **10.07 - 11.11：** ：**加入 Fracted 项目组**
  * **10.13 - 今天：** ：**加入 NTU ＆ Kaia 合作项目**
  * **11.15 - 今天：** ：**加入 Seth 项目**
